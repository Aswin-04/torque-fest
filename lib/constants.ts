...
import rajeshPic from "@/public/staff-coordinators/rajesh.jpg";                  
import venkataramanPic from "@/public/staff-coordinators/venkataraman.jpg";      
import boopathiPic from "@/public/staff-coordinators/bhoopathi.jpg";              
import tamilarasanPic from "@/public/staff-coordinators/tamilarasan.jpg";        
import sudhakarPic from "@/public/staff-coordinators/sudhakar.jpg";              
import vaidyanathanPic from "@/public/staff-coordinators/vaidhyanadan.jpg";      
import ravikumarPic from "@/public/staff-coordinators/ravikumar.jpg";            
import ramachandranPic from "@/public/staff-coordinators/ramachandran.jpg";      
import manivannanPic from "@/public/staff-coordinators/manivannan.jpg";          
import rajaprasannaPic from "@/public/staff-coordinators/rajaprasana.jpg";      
import dineshKumarPic from "@/public/our-team/staffs/dineshSir.jpg";        
import saravanakumarPic from "@/public/staff-coordinators/saravanakumar.jpg";    
import parswajinanPic from "@/public/staff-coordinators/paraswajinan.jpg";        
import babuPic from "@/public/staff-coordinators/babu.jpg";                      
import arunprasadPic from "@/public/staff-coordinators/arunprasad.jpg";          
import sivaChandranPic from "@/public/staff-coordinators/sivachandran.jpg";      
...
export const eventsData = [
  {
    ...
    staffCoordinators: [
      { image: venkataramanPic, name: "Dr. K. Venkataraman" },
      { image: boopathiPic, name: "Dr. R. Bhoopathi" }
    ],
    notes: [
...

  {
    ...
    staffCoordinators: [
      { image: rajeshPic, name: "Dr. S. Rajesh" }
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
...

  {
    ...
    staffCoordinators: [
      { image: tamilarasanPic, name: "Dr. U. Tamilarasan" },
      { image: sudhakarPic, name: "Mr. M. Sudhakar" }
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
...

  {
    ...
    staffCoordinators: [
      { image: vaidyanathanPic, name: "Dr. S. Vaidyanathan" },
      { image: ravikumarPic, name: "Mr. L. Ravi Kumar" },
      { image: ramachandranPic, name: "Dr. S. Ramachandran" },
      { image: manivannanPic, name: "Dr. A. Manivannan" }
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
...

  {
    ...
    staffCoordinators: [
      { image: rajaprasannaPic, name: "Mr. R. Rajaprasanna" }
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
...

  {
    ...
    staffCoordinators: [
      { image: dineshKumarPic, name: "Mr. S. K. Dinesh Kumar" }
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
...

  {
    ...
    staffCoordinators: [
      { image: saravanakumarPic, name: "Dr. L. Saravanakumar" },
      { image: parswajinanPic, name: "Dr. C. Parswajinan" }
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
...

  {
    ...
    staffCoordinators: [
      { image: parswajinanPic, name: "Dr. C. Parswajinan" } // same as above if shared
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
...

  {
    ...
    staffCoordinators: [
      { image: arunprasadPic, name: "Dr. S. Arunprasad" }
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
...

  {
    ...
    staffCoordinators: [
      { image: sivaChandranPic, name: "Mr. S. Siva Chandran" }
    ],
    notes: [
      "The confirmation mail will be sent to participants, and they will be added to a WhatsApp group for communication.",
      "Please note that the registration for this event is handled through a common Google Form.",
